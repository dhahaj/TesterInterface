...
public class JSerial implements SerialPortEventListener {
  ...
  public JSerial(eax2500_swing_test parent) {
    this(parent, "COM1", 9600, 'N', 8, 1);
  }

  public JSerial(eax2500_swing_test parent, int baudRate) {
    this(parent, "COM1", baudRate, 'N', 8, 1);
  }


  public JSerial(eax2500_swing_test parent, String portName) {
    this(parent, portName, 9600, 'N', 8, 1);
  }


  public JSerial(eax2500_swing_test parent, String portName, int baudRate) {
    this(parent, portName, baudRate, 'N', 8, 1);
  }

  public JSerial(eax2500_swing_test parent, String portName, int baudRate, char parity, int dataBits, float stopBits) {
    this.parent = parent;
